...
export default function CheckoutPage() {
  ...
  if (completedOrder) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center space-y-6 animate-fadeIn">
        <div className="w-16 h-16 bg-gold/15 border border-gold rounded-full flex items-center justify-center text-gold mx-auto">
        ...
        <p className="text-sm text-txt-muted max-w-lg mx-auto">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <h1 className="font-heading text-3xl font-bold text-txt-main border-b border-border-subtle pb-4">
        {t.checkout.title}
      </h1>

      {errorMsg && (
        <div className="p-4 bg-red-950/20 border border-red-500/40 text-red-600 rounded-[2px] text-xs font-semibold">
          {errorMsg}
        </div>
      )}
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <div className="bg-bg-card border border-border-subtle p-6 rounded-[2px] space-y-4 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div>
                <label className="block text-txt-muted font-medium mb-1">{t.checkout.fullName} *</label>
                <input
                  type="text"
                  required
                  value={recipientName}
              ...
              <div>
                <label className="block text-txt-muted font-medium mb-1">{t.checkout.phone} *</label>
                <input
                  type="text"
                  required
                  value={phone}
              ...
              <div className="sm:col-span-2">
                <label className="block text-txt-muted font-medium mb-1">{t.checkout.address} *</label>
                <input
                  type="text"
                  required
                  value={addressLine}
              ...
              <div>
                <label className="block text-txt-muted font-medium mb-1">{t.checkout.subdistrict}</label>
                <input
                  type="text"
                  value={subdistrict}
              ...
              <div>
                <label className="block text-txt-muted font-medium mb-1">{t.checkout.district}</label>
                <input
                  type="text"
                  value={district}
              ...
              <div>
                <label className="block text-txt-muted font-medium mb-1">{t.checkout.province}</label>
                <input
                  type="text"
                  value={province}
              ...
              <div>
                <label className="block text-txt-muted font-medium mb-1">{t.checkout.postalCode}</label>
                <input
                  type="text"
                  value={postalCode}
          ...
          <div className="bg-bg-card border border-border-subtle p-6 rounded-[2px] space-y-4 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="font-heading text-sm font-bold text-txt-main flex items-center gap-2">
            ...
            {taxInvoiceRequested && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs pt-3 border-t border-border-subtle animate-fadeIn">
                <div>
                  <label className="block text-txt-muted font-medium mb-1">{t.checkout.companyName} *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-txt-muted font-medium mb-1">{t.checkout.taxId} *</label>
                  <input
                    type="text"
                    required={taxInvoiceRequested}
                    value={taxId}
                ...
                <div>
                  <label className="block text-txt-muted font-medium mb-1">{t.checkout.branch}</label>
                  <input
                    type="text"
                    value={branch}
                ...
                <div>
                  <label className="block text-txt-muted font-medium mb-1">{t.checkout.taxAddress}</label>
                  <input
                    type="text"
                    value={taxAddress}
            ...
            <div className="space-y-3">
              {[
                ...
                return (
                  <label
                    key={pm.id}
                    className={`flex items-center justify-between p-4 rounded-[2px] border cursor-pointer transition-all ${
                      isSelected
                        ? 'border-gold bg-gold/10 text-gold font-bold shadow-sm'
                        : 'border-border-subtle text-txt-muted hover:border-gold/40 bg-bg-secondary/40'
                    }`}
                  >
