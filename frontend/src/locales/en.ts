export const en = {
  ...
  cms: {
    ...
    itemImageLabel: 'Image URL / Media ID',
    itemImagePlaceholder: 'Select from media library or enter image URL (max 1000 chars)',
    itemImageHelp: '* Recommended to click "Choose Media" button or paste valid image URL under 1,000 characters (avoid pasting oversized Base64 data)',
