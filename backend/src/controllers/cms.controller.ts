  ...
  try {
    ...
    const updated = await sql`
      ...
      SET
        ...
        media_id = COALESCE(${updates.mediaId !== undefined ? updates.mediaId : null}, media_id),
        custom_image_url = COALESCE(${updates.customImageUrl !== undefined ? updates.customImageUrl : null}, custom_image_url),
