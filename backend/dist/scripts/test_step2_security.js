...
async function runStep2SecurityAudit() {
    ...
    `;
        ...
        const hash1 = (0, auth_controller_1.hashRefreshToken)(sampleToken);
        const hash2 = (0, auth_controller_1.hashRefreshToken)(sampleToken);
        ...
        const testJti1 = crypto_1.default.randomUUID();
        const testRawRefreshToken1 = jsonwebtoken_1.default.sign({ sub: testUserId, jti: testJti1 }, refreshTokenSecret, { expiresIn: '7d', algorithm: 'HS256' });
        const testHash1 = (0, auth_controller_1.hashRefreshToken)(testRawRefreshToken1);
    ...
    `;
        ...
        const testJti2 = crypto_1.default.randomUUID();
        const testRawRefreshToken2 = jsonwebtoken_1.default.sign({ sub: testUserId, jti: testJti2 }, refreshTokenSecret, { expiresIn: '7d', algorithm: 'HS256' });
        const testHash2 = (0, auth_controller_1.hashRefreshToken)(testRawRefreshToken2);
        await sql `
      INSERT INTO sessions (user_id, jti, refresh_token_hash, expires_at)
