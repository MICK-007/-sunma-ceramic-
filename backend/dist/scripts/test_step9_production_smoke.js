...
exports.runProductionSmokeTest = runProductionSmokeTest;
...
async function runProductionSmokeTest() {
    ...
    console.log('==================================================\n');
    let uploadedMediaX = null;
    let uploadedMediaY = null;
    let orphanMediaZ = null;
    try {
        // --------------------------------------------------
        ...
        const uploadResX = await (0, storage_1.uploadCmsMedia)(mediaIdX, 'image/jpeg', realJpegBytes);
    ...
    `;
        ...
        const existsInStorageX = await (0, storage_1.mediaObjectExists)(storagePathX);
        ...
        const uploadResY = await (0, storage_1.uploadCmsMedia)(mediaIdY, 'image/png', realPngBytes);
    ...
    `;
      ...
      `;
        ...
        const uploadResZ = await (0, storage_1.uploadCmsMedia)(mediaIdZ, 'image/jpeg', realJpegBytes);
    ...
    `;
        ...
        await (0, storage_1.deleteCmsMedia)(storagePathZ);
        const checkDbDeletedZ = await sql `SELECT id FROM cms_media WHERE id = ${mediaIdZ}`;
        const checkStorageDeletedZ = await (0, storage_1.mediaObjectExists)(storagePathZ);
        ...
        await (0, storage_1.deleteCmsMedia)(uploadedMediaX.storage_path);
        await (0, storage_1.deleteCmsMedia)(uploadedMediaY.storage_path);
        console.log('\n==================================================');
