...
const migrate_storage_path_column_1 = require("./migrate_storage_path_column");
const results = [];
...
async function runPhase1Tests() {
    ...
    try {
        const bucketOk = await (0, storage_1.ensureCmsBucketExists)();
        if (bucketOk) {
    ...
    try {
        ...
        const pathInfo = (0, storage_1.getStoragePath)(testMediaId1, 'image/jpeg');
        if (pathInfo.storagePath)
            await (0, storage_1.deleteCmsMedia)(pathInfo.storagePath);
        const uploadRes = await (0, storage_1.uploadCmsMedia)(testMediaId1, 'image/jpeg', dummyJpegBuffer);
    ...
    try {
        const pathInfo = (0, storage_1.getStoragePath)(testMediaId2, 'image/png');
        if (pathInfo.storagePath)
            await (0, storage_1.deleteCmsMedia)(pathInfo.storagePath);
        const uploadRes = await (0, storage_1.uploadCmsMedia)(testMediaId2, 'image/png', dummyPngBuffer);
    ...
    try {
        const uploadRes = await (0, storage_1.uploadCmsMedia)('33333333-3333-4333-8333-333333333333', 'application/pdf', dummyJpegBuffer);
    ...
    try {
        const uploadRes = await (0, storage_1.uploadCmsMedia)('44444444-4444-4444-8444-444444444444', 'image/svg+xml', Buffer.from('<svg></svg>'));
        if (!uploadRes.success && uploadRes.code === 'MEDIA_STORAGE_INVALID_MIME') {
    ...
    try {
        ...
        const uploadRes = await (0, storage_1.uploadCmsMedia)('55555555-5555-4555-8555-555555555555', 'image/jpeg', oversizedBuffer);
    ...
    try {
        const pathInfo = (0, storage_1.getStoragePath)('66666666-6666-4666-8666-666666666666', 'image/webp');
    ...
    try {
        const pathInfo1 = (0, storage_1.getStoragePath)('../../../etc/passwd', 'image/jpeg');
        const pathInfo2 = (0, storage_1.getStoragePath)('66666666-6666-4666-8666-666666666666/../../admin', 'image/jpeg');
    ...
    try {
        const delRes1 = await (0, storage_1.deleteCmsMedia)(`cms/media/${testMediaId1}.jpg`);
        const delRes2 = await (0, storage_1.deleteCmsMedia)(`cms/media/${testMediaId2}.png`);
    ...
    try {
        const migrationSuccess1 = await (0, migrate_storage_path_column_1.migrateStoragePathColumn)();
        const migrationSuccess2 = await (0, migrate_storage_path_column_1.migrateStoragePathColumn)();
