...
exports.runLegacyBase64Migration = runLegacyBase64Migration;
...
async function runLegacyBase64Migration() {
  ...
  `;
    ...
    for (const record of records) {
        ...
        try {
            ...
            if (!storage_1.ALLOWED_MIME_MAP[detectedMime]) {
            ...
            const uploadRes = await (0, storage_1.uploadCmsMedia)(mediaId, detectedMime, buffer);
