...
exports.logCmsAuditEvent = logCmsAuditEvent;
exports.getPublicPageBySlug = getPublicPageBySlug;
exports.getAdminPageDraftBySlug = getAdminPageDraftBySlug;
exports.reorderAdminCmsSections = reorderAdminCmsSections;
exports.updateAdminCmsSection = updateAdminCmsSection;
exports.createAdminCmsItem = createAdminCmsItem;
exports.updateAdminCmsItem = updateAdminCmsItem;
exports.deleteAdminCmsItem = deleteAdminCmsItem;
exports.publishAdminCmsPage = publishAdminCmsPage;
exports.getAdminCmsPageVersions = getAdminCmsPageVersions;
exports.rollbackAdminCmsPage = rollbackAdminCmsPage;
exports.getAdminCmsAuditLogs = getAdminCmsAuditLogs;
const db_1 = require("../db");
async function logCmsAuditEvent(options) {
 ...
 */
async function getPublicPageBySlug(req, res) {
    ...
    `;
        ...
        const filteredSections = (payload.sections || [])
            ...
            .map((sec) => {
            const secItems = (payload.items || []).filter((item) => item.section_id === sec.id && item.is_enabled);
            return {
                ...sec,
                items: secItems,
            };
 ...
 */
async function getAdminPageDraftBySlug(req, res) {
    const { slug } = req.params;
    const sql = (0, db_1.getDbClient)();
    if (!sql) {
        return res.status(500).json({ success: false, message: 'Database connection failure.' });
 ...
 */
async function reorderAdminCmsSections(req, res) {
 ...
 */
async function updateAdminCmsSection(req, res) {
    const { id } = req.params;
 ...
 */
async function createAdminCmsItem(req, res) {
 ...
 */
async function updateAdminCmsItem(req, res) {
    const { id } = req.params;
    const updates = req.body;
    const sql = (0, db_1.getDbClient)();
    if (!sql) {
 ...
 */
async function deleteAdminCmsItem(req, res) {
    const { id } = req.params;
    const sql = (0, db_1.getDbClient)();
    if (!sql) {
        return res.status(500).json({ success: false, message: 'Database connection failure.' });
 ...
 */
async function publishAdminCmsPage(req, res) {
    const { slug } = req.params;
    const sql = (0, db_1.getDbClient)();
    if (!sql) {
        return res.status(500).json({ success: false, message: 'Database connection failure.' });
 ...
 */
async function getAdminCmsPageVersions(req, res) {
    const { slug } = req.params;
    const sql = (0, db_1.getDbClient)();
    if (!sql) {
        return res.status(500).json({ success: false, message: 'Database connection failure.' });
 ...
 */
async function rollbackAdminCmsPage(req, res) {
    const { slug } = req.params;
 ...
 */
async function getAdminCmsAuditLogs(req, res) {
    const sql = (0, db_1.getDbClient)();
    if (!sql) {
        return res.status(500).json({ success: false, message: 'Database connection failure.' });
    }
